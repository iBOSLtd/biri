...
namespace PeopleDesk.Controllers.Global
{
    ...
    public class DocumentController : ControllerBase
    {
            ...
            IHostEnvironment hostEnvironment)
        {
            ...
            client = hostEnvironment.IsProduction() ? new BlobServiceClient(Environment.GetEnvironmentVariable("blob_connection"))
                : new BlobServiceClient("DefaultEndpointsProtocol=https;AccountName=peopledeskfile;AccountKey=FifcLsaEVpm/GxuNeW8kolOVLsEc/GofOUsvxdDzBkJiAJmLN1f9XRsKrg+cQYCo0CRfcxadjw0B+AStPjpRnw==;EndpointSuffix=core.windows.net");
        }
            ...
            try
            {
                ...
                foreach (var file in files)
                {
                    if (file.Length > maxFileSize)
                    {
                        ...
                        {
                            FileName = file.Name,
                            Message = "Maximum File Size Allowed (5MB) Your File Size (" + fileSize + "MB)"
                        };
                        errors.Add(error);
                    }
                }
                ...
                else
                {
                    foreach (var file in files)
                    {
                        ...
                        BlobContainerClient container = client.GetBlobContainerClient("akijbiri");
        ...
        public async Task<IActionResult> DownloadFile(long id)
        {
            try
            {
                //BlobServiceClient client = new BlobServiceClient(Environment.GetEnvironmentVariable("blob_connection"));
        ...
        //    try
        //    {
        //        BlobContainerClient new_container = client.GetBlobContainerClient("akijbiri");
        ...
        //                    {
        //                        //PeopleDesk.Data.Entity.akijbiri.GlobalFileUrl obj = new PeopleDesk.Data.Entity.akijbiri.GlobalFileUrl
        //                        //{
        ...
        //                        //};
        //                        //await _akijbiri.GlobalFileUrls.AddAsync(obj);
        //                        //await _akijbiri.SaveChangesAsync();
        //                    }
        //                }
